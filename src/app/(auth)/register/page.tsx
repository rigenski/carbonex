...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Section - Hero */}
      <div className="relative hidden overflow-hidden bg-emerald-600 lg:flex lg:w-1/2">
        {/* Background Elements */}
        ...
        <div className="relative flex flex-col justify-center px-12 py-16">
          ...
          <div className="space-y-4">
            <div className="flex items-center text-white/90">
              ...
              />
              <span>Create verified carbon credit projects</span>
            </div>
            <div className="flex items-center text-white/90">
              <Icon
                icon="mdi:check-circle"
        ...
        <div className="w-full max-w-4xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              {errors.idCard && (
                <p className="mt-1 text-sm text-red-600">ID card is required</p>
              )}
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="rounded-lg border-gray-200 bg-white pr-10"
                  />
                  <button
                    type="button"
