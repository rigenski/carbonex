...
export default function Chatbot() {
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const responses = [
        ...
        "You can explore projects by location, type, or carbon impact. The Projects page has detailed filters to help you find exactly what you're looking for.",
  ...
  return (
    <div className="fixed right-6 bottom-6 z-50">
      {isOpen ? (
        <div className="mb-4 h-96 w-80 rounded-lg bg-white shadow-2xl">
          {/* Header */}
          <div className="bg-primary rounded-t-lg p-4 text-white">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <div className="h-8 w-8 rounded-full bg-white/20"></div>
                <div>
                  <div className="font-semibold">CarbonBot</div>
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                className="h-8 w-8 rounded-full shadow-lg hover:scale-110"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
